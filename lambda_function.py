...
sns_topic_arn = 'arn:aws:sns:us-east-1:730335181268:Sns-for-doordash'
...
def lambda_handler(event, context):
    try:
        ...
        target_bucket = 'doordash-target-zn-sai'
        target_key = f'{key.rsplit("/", 1)[-1].rsplit(".", 1)[0]}_filtered.json'
        ...
        error_message = f'Missing key in event: {ke}'
    except FileNotFoundError:
        error_message = f'File not found: {key}'
